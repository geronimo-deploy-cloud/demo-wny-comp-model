"""Model definition for expected-transaction-price.
...
from .features import ExpectedTransactionPriceFeatures
from .data_sources import training_rochester, training_macro


class ExpectedTransactionPriceModel(Model):
    """XGBoost model trained on Rochester property data.
    ...
    name = "expected-transaction-price"
    version = "1.0.0"
    
    def __init__(self):
        super().__init__()
        self.estimator: Optional[Any] = None
        self.features: Optional[ExpectedTransactionPriceFeatures] = None
