...
from .model import ExpectedTransactionPriceModel
...
class ExpectedTransactionPriceEndpoint(Endpoint):
    ...
    To train a model:
        uv run python -m expected_transaction_price.train
    """

    model_class = ExpectedTransactionPriceModel
