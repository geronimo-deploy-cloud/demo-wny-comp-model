...
import os
from expected_transaction_price.monitoring.alerts import AlertManager, SlackAlert, AlertSeverity
...
def create_drift_detector(reference_data=None):
    ...
    """
    from expected_transaction_price.monitoring.drift import DriftDetector
...
def check_thresholds(metrics: MetricsCollector, alerts: AlertManager) -> None:
    ...
    Example:
        ...
        from expected_transaction_price.sdk.monitoring_config import (
            create_alert_manager, check_thresholds
        )
        from expected_transaction_price.monitoring.metrics import metrics
