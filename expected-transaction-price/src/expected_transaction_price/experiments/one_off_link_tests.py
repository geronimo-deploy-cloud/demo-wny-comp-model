...
def main():
    ...
    if args.url:
        ...
        if not features.get("assessed_value"):
            from expected_transaction_price.sdk.data_sources import lookup_rochester_assessment
        ...
        from expected_transaction_price.sdk.mls import MLSClient
    ...
    from expected_transaction_price.sdk.data_sources import training_macro, UNIFIED_COLUMNS
    import os
    from dotenv import load_dotenv
    # FRED_API_KEY lives in the project root expected-transaction-price/.env (three dirs up from experiments/)
    ...
    from expected_transaction_price.sdk.data_sources import _assign_school_districts
