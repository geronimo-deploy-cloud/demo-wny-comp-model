...
@pytest.fixture
def endpoint():
    """Compact CompModelEndpoint for testing."""
    from comp_model.sdk.endpoint import CompModelEndpoint
    ep = CompModelEndpoint()
...
class TestBuildDataFrame:
    ...
    def test_all_columns_present(self, endpoint):
        ...
        from comp_model.sdk.data_sources import UNIFIED_COLUMNS
...
class TestEnrichDataFrame:
    ...
    def test_no_fred_api_key_returns_nan_columns(self, endpoint):
        ...
        with patch("comp_model.sdk.endpoint._assign_school_districts", side_effect=lambda df: df):
    ...
    @patch("comp_model.sdk.endpoint._assign_school_districts", side_effect=lambda df: df)
    @patch("comp_model.sdk.endpoint.training_macro")
...
class TestEndpointAssembly:
    ...
    def test_endpoint_has_pipeline_methods(self):
        ...
        for name in methods:
            assert hasattr(CompModelEndpoint, name), f"Missing method: {name}"
