...
from comp_model.monitoring.middleware import MonitoringMiddleware
...
PROJECT_NAME = _config.project.name if _config else "comp_model"
...
if ENABLE_MCP:
    try:
        from comp_model.agent import mcp
