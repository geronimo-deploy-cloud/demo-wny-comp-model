...
import os
from comp_model.monitoring.alerts import AlertManager, SlackAlert, AlertSeverity
from comp_model.monitoring.metrics import MetricsCollector
...
def create_drift_detector(reference_data=None):
    ...
    """
    from comp_model.monitoring.drift import DriftDetector
...
def check_thresholds(metrics: MetricsCollector, alerts: AlertManager) -> None:
    ...
    Example:
        ...
        from comp_model.sdk.monitoring_config import (
            create_alert_manager, check_thresholds
        )
        from comp_model.monitoring.metrics import metrics
